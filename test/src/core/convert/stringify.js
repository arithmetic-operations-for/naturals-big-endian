...
macro.title = ( providedTitle , from , to , array , i , j , expected ) => providedTitle || `stringify ${JSON.stringify(array)}[${i}:${j}]_${from} ->_${to} = ${expected}` ;
...
test( macro , 10000 , 16 , [ 255 ] , 0 , 1 , 'ff' ) ;

test( macro , 100 , 16 , [ 18 , 36 , 47 , 58 , 54 , 44 , 93 , 6 , 47 , 20 ] , 0 , 10 , 'fedcba9876543210' ) ;
...
test( macro ,
	10 , 36 ,
	[ 3,1,2,6,4,8,5,6,5,0,0,0,2,8,0,6,5,9,9,6,1,6,7,8,5,6,4,7,4,5,1,0,5,2,2,8,1,2,5,0,5,6,4,4,3,6,2,6,4,0,9,4,3,5,5] ,
	0 , 55 ,
	'1234567890azertyuiopqsdfghjklmwxcvbn'
) ;

test( macro , 10000 , 36 , [ 55 , 3415 ] , 0 , 2 , 'bv0n' ) ;
