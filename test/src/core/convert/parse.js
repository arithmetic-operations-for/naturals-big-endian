...
test( 'parse' , function ( assert ) {
	...
	assert.deepEqual( integer.parse( 16 , 2 , '3' ) , [ 1 , 1 ] ) ;

	assert.deepEqual( integer.parse( 2 , 16 , '10001' ) , [ 1 , 1 ] ) ;
	assert.deepEqual( integer.parse( 16 , 2 , '11' ) , [ 1 , 0 , 0 , 0 , 1 ] ) ;

	assert.deepEqual( integer.parse( 2 , 10 , '11' ) , [ 3 ] ) ;
	assert.deepEqual( integer.parse( 10 , 2 , '3' ) , [ 1 , 1 ] ) ;

	assert.deepEqual( integer.parse( 10 , 16 , '256' ) , [ 1 , 0 , 0 ] ) ;
	assert.deepEqual( integer.parse( 16 , 10 , '100' ) , [ 2 , 5 , 6 ] ) ;

	assert.deepEqual( integer.parse( 10 , 16 , '255' ) , [ 15 , 15 ] ) ;
