...
test( 'parse' , t => {
	...
	t.throws( integer.parse.bind( null , 16 , 16 , '!00b0C0def' ) , { message: /invalid/ } ) ;
	...
	t.deepEqual( integer.parse( 2 , 2 , '1001010111' ) , [ 1 , 0 , 0 , 1 , 0 , 1 , 0 , 1 , 1 , 1 ] ) ;
	...
	t.deepEqual( integer.parse( 16 , 16 , 'a00b0C0def' ) , [ 10 , 0 , 0 , 11 , 0 , 12 , 0 , 13 , 14 , 15 ] ) ;
