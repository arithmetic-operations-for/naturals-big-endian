...
test('bignum.stringify', function(assert){
	...
	bstringify8_2  = alu.stringify_t(Math.pow(2, 8), 2, algo.fiter, zfill_t);
	bstringify8_4  = alu.stringify_t(Math.pow(2, 8), 4, algo.fiter, zfill_t);
	bstringify8_16 = alu.stringify_t(Math.pow(2, 8), 16, algo.fiter, zfill_t);

	bstringify16_2  = alu.stringify_t(Math.pow(2, 16), 2, algo.fiter, zfill_t);
	bstringify16_4  = alu.stringify_t(Math.pow(2, 16), 4, algo.fiter, zfill_t);
	bstringify16_16 = alu.stringify_t(Math.pow(2, 16), 16, algo.fiter, zfill_t);

	bstringify32_2  = alu.stringify_t(Math.pow(2, 32), 2, algo.fiter, zfill_t);
	bstringify32_4  = alu.stringify_t(Math.pow(2, 32), 4, algo.fiter, zfill_t);
	bstringify32_16 = alu.stringify_t(Math.pow(2, 32), 16, algo.fiter, zfill_t);

	bstringify10   = alu.stringify_t(10, 10, algo.fiter, zfill_t);
	bstringify100  = alu.stringify_t(100, 10, algo.fiter, zfill_t);
	bstringify1000 = alu.stringify_t(1000, 10, algo.fiter, zfill_t);
	...
	bstringify8_2  = alu.stringify_t(Math.pow(2, 8), 2, algo.biter, zfill_t);
	bstringify8_4  = alu.stringify_t(Math.pow(2, 8), 4, algo.biter, zfill_t);
	bstringify8_16 = alu.stringify_t(Math.pow(2, 8), 16, algo.biter, zfill_t);

	bstringify16_2  = alu.stringify_t(Math.pow(2, 16), 2, algo.biter, zfill_t);
	bstringify16_4  = alu.stringify_t(Math.pow(2, 16), 4, algo.biter, zfill_t);
	bstringify16_16 = alu.stringify_t(Math.pow(2, 16), 16, algo.biter, zfill_t);

	bstringify32_2  = alu.stringify_t(Math.pow(2, 32), 2, algo.biter, zfill_t);
	bstringify32_4  = alu.stringify_t(Math.pow(2, 32), 4, algo.biter, zfill_t);
	bstringify32_16 = alu.stringify_t(Math.pow(2, 32), 16, algo.biter, zfill_t);

	bstringify10   = alu.stringify_t(10, 10, algo.biter, zfill_t);
	bstringify100  = alu.stringify_t(100, 10, algo.biter, zfill_t);
	bstringify1000 = alu.stringify_t(1000, 10, algo.biter, zfill_t);
